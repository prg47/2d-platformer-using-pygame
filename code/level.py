...
from sprites import Sprite, MovingSprite , AnimatedSprites, Spike, Item, ParticleEffectSprite
...
class Level:
    def __init__(self, tmx_map,level_frames,audio_files, data,switch_stage):
        ...
        self.all_sprites = AllSprites(
            ...
            clouds = {'large':level_frames['cloud_large'],
    ...
    def setup(self, tmx_map,level_frames,audio_files):
        ...
        for obj in tmx_map.get_layer_by_name('Moving Objects'):
            if obj.name == "spike":
                ...
                groups = (self.all_sprites,self.sem_collision_sprites) if obj.properties['platform'] else (self.all_sprites,self.damage_sprites)
        ...
        for obj in tmx_map.get_layer_by_name('Water'):
            ...
            for row in range(rows):
                for col in range(cols):
                    ...
                    if row == 0:
                        AnimatedSprites((x,y),level_frames['water_top'],self.all_sprites,Z_LAYERS['water'])
                    else:
